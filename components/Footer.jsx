    ...
    return (
        <div id='intro' className="mt-4 mb-10 lg:mb-0">
            <div className="flex h-10 items-center justify-between text-xs font-normal text-LightGray py-4 px-2 md:px-4 w-full bg-MidNightBlack">
                ...
                <div className="flex items-center">
                    <a href='https://www.github.com/greasysweet' target="_blank" rel="noreferrer">Made with ❤️ by <span className='font-bold'>Greasy Sweet</span></a>
                </div>
                <div className="hidden md:flex items-center">
                    <div className="mr-1 text-base">
                        <MdMail />
                    </div>
                    <div>greasysweetsec@gmail.com</div>
                </div>
            </div>
        </div>
    )
